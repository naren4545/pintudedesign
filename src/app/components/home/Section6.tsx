...
export default function Section6() {
  return (
    <section className="">
     ...
     <p className='max-w-[772px] font-normal mx-auto text-2xl text-center mb-5'>Find answers to common questions about PinTude, our services, 
     and how we can help your business grow.</p>
