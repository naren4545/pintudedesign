        ...
        <div className="grid grid-cols-1 place-items-center px-4 pt-5 lg:place-items-start lg:grid-cols-7 gap-8 mt-10">
          <div className=" md:col-span-3 relative top-[12px]   ">
            <div className="relative">
              <FooterLogo />
              <p className="pb-3 max-w-[368px] mx-auto lg:mx-0 ">
                Our mission is to help businesses establish an effortless online
                presence and connect with customers in their local area.
              </p>
            </div>
          </div>
            ...
            <div className="flex">
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_2850_1509"
                      />
                      <feOffset />
                      ...
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_2850_1509"
                        result="shape"
                      />
                    </filter>
                  </defs>
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M29.5 28.875H32.625L33.875 23.875H29.5V21.375C29.5 20.0875 29.5 18.875 32 18.875H33.875V14.675C33.4675 14.6213 31.9287 14.5 30.3037 14.5C26.91 14.5 24.5 16.5712 24.5 20.375V23.875H20.75V28.875H24.5V39.5H29.5V28.875Z"
                    fill="white"
                  />
                  <defs>
                    <filter
                      id="filter0_d_2850_1505"
                      x="0"
                      y="0"
                      width="54"
                      height="54"
                    ...
                    >
                      ...
                      <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_2850_1505"
                      />
                      <feOffset />
                      <feGaussianBlur stdDeviation="3" />
                      <feComposite in2="hardAlpha" operator="out" />
                      ...
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_2850_1505"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_2850_1501"
                      />
                      <feOffset />
                      <feGaussianBlur stdDeviation="3" />
                      <feComposite in2="hardAlpha" operator="out" />
                      ...
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_2850_1501"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feMorphology
                        ...
                        operator="dilate"
                        in="SourceAlpha"
                        result="effect1_dropShadow_3025_1295"
                      />
                      <feOffset />
                      <feGaussianBlur stdDeviation="3" />
                      <feComposite in2="hardAlpha" operator="out" />
                      ...
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_3025_1295"
                        result="shape"
                      />
                    </filter>
                  </defs>
