  ...
  const faqs = [
    {
      ...
      answer: "Pintude only accepts UPI payments. All major UPI payment is accepted for a seamless and quick transaction experience."
    },
    {
      ...
      {faqs.map((faq, index) => (
        <div key={index} className="mb-2">
          <button
            ...
            className="w-full flex flex-col text-left overflow-hidden p-4 bg-[#f5fcfe] border border-[#c6e7f4] rounded-[23px] shadow-lg transition-all duration-500 ease-in-out"
          >
