...
const HeroContent = memo(() => (
  <div className="hero-content max-w-[734px]">
    ...
    <p className="text-[#F6830E] text-2xl">
      ...
      presence. Build a personalized profile, showcase your products, and let
      customers find you effortlessly.
    </p>
    <HeroSlider />
  </div>
));
...
export default function HeroSection() {
  return (
    <section className="bg-[linear-gradient(180deg,#FFFFFF_82.34%,#13A8DA_107%)] lg:bg-[linear-gradient(180deg,#FFFFFF_8.34%,#13A8DA_100%)]">
